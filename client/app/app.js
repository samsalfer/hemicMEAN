...
angular.module('hemicApp', [ngCookies, ngResource, ngSanitize, 'btford.socket-io', uiRouter,
  uiBootstrap, _Auth, account, admin, 'validation.match', navbar, footer, main, structure, combine, composition, validation, terminology, project, constants,
...
angular.element(document)
  .ready(() => {
    angular.bootstrap(document, ['hemicApp'], {
      strictDi: true
    });
  });
